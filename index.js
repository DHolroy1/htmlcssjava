...
// const squares = numbers.map((number, index,)=>{return number * number})

// console.log("numbers", numbers)
// console.log("squares", squares)

// const evenNumbers = numbers.filter((number, index)=>{return number % 2 == 0})

// console.log("evenNumbers", evenNumbers)

// const sum = numbers.reduce((previousValue, currentValue)=>{previousValue = previousValue + currentValue
